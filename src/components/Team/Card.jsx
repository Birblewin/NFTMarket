      ...
      <div className="bg-blackish pb-5 border-2 border-border-gray rounded-xl mr-9 mt-5">
        ...
        <div className='flex flex-col flex-nowrap w-full text-left'>
          ...
          <div className="flex flex-row flex-nowrap gap-3 cursor-pointer px-6 pb-4 pt-3">
            <NavLink href="" target="_blank"><Icon icon="skill-icons:instagram" width="26" height="26" /></NavLink>
            <NavLink href="" target="_blank"><Icon icon="logos:discord-icon" width="26" height="26" /></NavLink>
            <NavLink href="https://github.com/Brikita" target="_blank"><Icon icon="ant-design:github-filled" width="26" height="26" /></NavLink>
          </div>
        </div>
      </div>
      <div className="bg-blackish pb-5 border-2 border-border-gray rounded-xl mr-9 mt-5">
