  ...
  return (
    ...
    <div className="paragraph-container">
      ...
      <div className="division1" style={{ backgroundColor: '#1d2022' }}>
        ...
        <h1 style={{fontSize:'10px', color:'#FFFF', marginTop: '10px'}}>public</h1>
        <div className='timer'>
        <CountdownTimer/>
        </div>
        </div>
    <p style={{color: '#C5B206', fontSize:'9px', marginBottom:'-30px'}}>1212.2K. 44K</p>
      </div>
      ...
      <h2 style={{fontSize:'10px', marginTop:'-38px', paddingRight:'60px', color:'#FFFF'}}>Total minted</h2>
        ...
        <div className='connection'>
          ...
          {/* <CurrencyBitcoinIcon/> */}
          <button style={{backgroundColor:'#FFDB24', color: '#363636', borderRadius:'20px'}}>connect wallet</button>
          </div>
        </div>
      </div>
      ...
      <div className="division3" style={{ backgroundColor: '#1d2022'}}>
        <button style={{backgroundColor:'#2a2a24',padding:'18px',paddingLeft:'30px',paddingRight:'30px', borderRadius:'30px',marginLeft:'180px', fontSize:'8px'}}>Make offer</button><button style={{backgroundColor:'#2a2a24',padding:'18px',paddingLeft:'30px',paddingRight:'30px', borderRadius:'30px',fontSize:'8px'}}>Explore all NFTs</button>
      </div>
    </div>
