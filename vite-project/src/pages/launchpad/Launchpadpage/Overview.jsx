  ...
  return (
    <div className="two-column">
      <div className="left-column">
        ...
        <div className='socials'>
          ...
          <button id='bt'>
            <a href="https://discord.com/login">
              <Icon icon="ic:baseline-discord" width={40} height={40}/>
            </a>
          </button>

          <button id='bt'>
            <a href="https://discord.com/login"></a>
            <Icon icon="mdi:github" width={40} height={40} color='#551A8B'/>
          </button>
        </div>
        ...
        <p>The next addition to our Season 1 range is no other than the Famous Fox Federation. You can mint your digital FFF figure then use our seamless `redeem shop` to pay shipping, claim your physical figure, and FREE Geek Card NFT. This time we have two versions that can be minted, 250 of each, 500 total. Limited edition will never re-run. With AR activations, custom branded packaging and custom `pop protector` enjoy a unique unboxing experience like no other!</p>&nbsp;
